...
# Keep it simple: deploy into the account's default VPC.
...
resource "aws_iam_openid_connect_provider" "github" {
  ...
  # Common GitHub Actions OIDC thumbprint; if AWS ever updates, refresh accordingly.
...
resource "aws_ecs_service" "app" {
  ...
  lifecycle {
    # CI/CD updates the service to newer task definition revisions.
